...
Define Lebesgue integrals as $\int_A f(x) dx = \sum_{Z\in S}k_Z\int_Z a_Z(x) dx$.

It is easy to show that this definition does not depend on the choice of~$k_Z$ and~$a_Z$.

\begin{grayed}
Define Lebesgue integrals on the space of continuous generalized limits functions \href{https://chatgpt.com/s/t_6937850a6b68819190a49e130f270ddb}{the same way} as Lebesgue integrals on the space of functions with real number values. This requires existence of (possibly infinite) supremum of a set of supersingularities.
