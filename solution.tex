...
Let define (Rimann) integrals on the space of generalized limits functions by the same formulas as classic integrals.

\begin{thm}
If an integral is absolutely convergent, then it is convergent.
\end{thm}
