...
\begin{enumerate}
\item $\setcond{x\in X}{f(x)\ne 0}$ is partitioned into Lebesgue measurable sets (\emph{zones}), each zone \[ Z=\setcond{x\in X}{\exists a\in\mathbb{R}\setminus\{0\}:f(x)=ka} \] for some $k\in\SUPER(\mathbb{R})\setminus\{0\}$.
