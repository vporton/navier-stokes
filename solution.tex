...
\[ ?? \]
\emph{Porton solutions} of Navier-Stokes equations.
\end{defn}

\begin{thm}
Porton solutions of Navier-Stokes equations restricted to differentiable\fxnote{Point the exact differentiability class.} functions are exactly solutions of Navier-Stokes equations taken on the space of supersingularities.
\end{thm}
