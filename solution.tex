...
\[ \sup B = \sup\setcond{\limsup_{x\to 0} f(x)}{\lim_{x\to 0} f(x) \in B} \]

\begin{rem}
Lebesgue integral is infinite, if $\sup B$ wents infinite on at least one ultrafilter.\fnote{Explain.}
\end{rem}
