...
(Because we may need $C^\infty$ to warrant integrability, it proves only existence of unique smooth solutions, but not uniqueness of all solutions.)
...
\fxerror{Continuity of derivative doesn't follow from continuity of~$u$.}Represent $u$ through zones. On each zone it's continuous, therefore it's continuous on the entire $[0,t]$.
\end{proof}
