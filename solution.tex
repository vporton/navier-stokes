...
Take $h=f'\sqcup g''=g'\sqcap f''$. Thus, from obvious monotonicity of $\lim$,\fxerror{It's not yet proved, that it's a partial order!}
\[ a\leq\lim_{x\to 0}h(x)\leq b \quad\text{and}\quad a\geq\lim_{x\to 0}h(x)\geq b. \]
So, $a=b$.
\end{proof}
