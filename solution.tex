...
\begin{thm}
$C^\infty$ supersingular mild solutions of Navier-Stokes equations are exactly $C^\infty$ solutions of Navier-Stokes equations (without the requirement that~$p$ is $C^\infty$) taken on the space of supersingularities (almost everywhere).
\end{thm}
