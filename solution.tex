...
\fxwarning{But each continuous function has an antiderivative, isn't this enough, so not needing the space of distributions? \href{https://chatgpt.com/s/t_69364f2479308191b79639101dbbfa48}{Here} it's said that the term under the integral is continuous, so we can define it through the antiderivative.}
